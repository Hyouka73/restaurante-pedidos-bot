...
import { Store, Phone, Home, Bot, Shield, MapPin, Sparkles } from 'lucide-react';
    ...
    >
      ...
      <WizardComponents.WizardCard>
        <WizardComponents.WizardInputField
          ...
          required
          icon={Store}
          helperText="Este nombre aparecerá en tus mensajes"
        />
      ...
      <WizardComponents.WizardCard>
        ...
        <div>
          <label className="label pb-1.5 sm:pb-2">
            <span className="label-text text-xs sm:text-sm font-semibold text-gray-700 flex items-center gap-1">
              Ubicación del Restaurante
              <span className="text-[#ff7f50] text-base sm:text-lg">*</span>
            </span>
          </label>
          <motion.button
            type="button"
      ...
      <WizardComponents.WizardCard className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
        ...
        <WizardComponents.WizardInputField
          ...
          required
          icon={Bot}
          helperText="Obtén tu token desde @BotFather"
        />
